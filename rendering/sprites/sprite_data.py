...
class SpriteData:
    ...
    def random_asset(asset=None):
        ...
        if asset is None:
            ...
            r = asset
        if r == 0:
            data = {"asset": "assets/sprites/billboard01.png", "width": 300, "height": 170}
        elif r == 1:
            data = {"asset": "assets/sprites/billboard02.png", "width": 215, "height": 220}
        elif r == 2:
            data = {"asset": "assets/sprites/billboard03.png", "width": 230, "height": 220}
        elif r == 3:
            data = {"asset": "assets/sprites/billboard04.png", "width": 268, "height": 170}
        elif r == 4:
            data = {"asset": "assets/sprites/billboard05.png", "width": 298, "height": 190}
        elif r == 5:
            data = {"asset": "assets/sprites/billboard06.png", "width": 298, "height": 190}
        elif r == 6:
            data = {"asset": "assets/sprites/billboard07.png", "width": 298, "height": 190}
        elif r == 7:
            data = {"asset": "assets/sprites/billboard08.png", "width": 385, "height": 265}
        elif r == 8:
            data = {"asset": "assets/sprites/billboard09.png", "width": 328, "height": 282}
        elif r == 9:
            ...
            data = {"asset": "assets/sprites/palm_tree.png", "width": 215, "height": 540}
        elif r == 21:
            data = {"asset": "assets/sprites/stump.png", "width": 195, "height": 140}
        elif r == 22:
            data = {"asset": "assets/sprites/tree1.png", "width": 360, "height": 360}
        elif r == 23:
            data = {"asset": "assets/sprites/tree2.png", "width": 282, "height": 295}
        else:
            data = {"asset": "assets/sprites/tree1.png", "width": 360, "height": 360}
        return data
